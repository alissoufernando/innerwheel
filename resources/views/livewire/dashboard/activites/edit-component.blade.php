...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <!--end breadcrumb-->
        <div class="row">
            <h6 class="mb-0 text-uppercase">Modifier une Activité</h6>
                <hr/>
                    ...
                    <form wire:submit.prevent='updateActiveAction'>
                        <div class="row card-body">
                            ...
                            <div wire:ignore class="col-md-12 mb-3">
                                ...
                                <textarea id="" name="mytextarea" wire:model="description">Description</textarea>
                            ...
                            <div class="col-md-12 mt-5">
                                <button type="submit"  class="btn btn-outline-primary btn-sm float-end">Modifier</button>
