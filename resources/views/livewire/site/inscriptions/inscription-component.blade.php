            ...
            <div class="row justify-content-center ">
                ...
                <div class="col-md-6 shadow">
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <select class="form-control" name="" id="" wire:model="mode_arrivee_id">
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <input type="date" class="form-control" placeholder="date d'arrivée" wire:model="date_arrivee">
                        @error('date_arrivee')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-md-12 mb-4">
                        ...
                        <input type="date" class="form-control" placeholder="date depart" wire:model="date_depart">
                        @error('date_depart')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-md-12 mb-4">
                        ...
                        <select class="form-control" name="" id="" wire:model="hebergement_id">
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <select class="form-control" name="" id="" wire:model="tarif_id">
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <select class="form-control" name="" id="" wire:model="activite_id">
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <select class="form-control" name="" id="" wire:model="Mode_paiement_id">
                ...
                <div class="col-md-6 shadow">
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <p> <strong>Club</strong>: {{ $this->Dclub->libelle}} => {{ $this->Dclub->prix }} FCFA</p>
                    ...
                    <div class="col-md-12 mb-4">
                        <h6 class="text-center"> <strong>Informations personnelles</strong> </h6>
                        <p> <strong>Mode d'arrivée</strong>: {{ $this->mode_arrivee_id }} </p>
                        ...
                        <p> <strong>Mode de paiement</strong>: {{ $this->Mode_paiement_id }} </p>
                    </div>
