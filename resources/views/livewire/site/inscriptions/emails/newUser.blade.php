...
<head>
  <meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
    <title>INNER WHEEL | DISTRICT 909 x NEW USER</title>
    ...
    <tr>
      <td>
        <table style="background-color: #f2f3f8; max-width:670px; margin:0 auto;" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:670px; background:#fff; border-radius:3px; text-align:center;-webkit-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);-moz-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);box-shadow:0 6px 18px 0 rgba(0,0,0,.06);">
                ...
                <tr>
                  <td style="padding:0 35px;">
                    <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">Bienvenue sur innerwheeldistrict909.com
                    </h1>
                    <p style="font-size:15px; color:#455056; margin:8px 0 0; line-height:24px;">
                        Votre compte a été créé sur <a href="{{ route('welcome') }}">innerwheeldistrict909.com</a>. Vous trouverez ci-dessous les informations d'identification générées par votre système, <br><strong>Veuillez modifier
          ...
          <tr>
            <td style="text-align:center;">
              <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">&copy; <strong>innerwheeldistrict909.com</strong> </p>
            </td>
          </tr>
          <tr>
            <td style="height:80px;">&nbsp;</td>
