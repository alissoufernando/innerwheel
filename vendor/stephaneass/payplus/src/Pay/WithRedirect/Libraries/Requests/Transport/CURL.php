<?php
namespace StephaneAss\Payplus\Pay\WithRedirect\Libraries\Requests\Transport;

use StephaneAss\Payplus\Pay\WithRedirect\Libraries\Requests;
use StephaneAss\Payplus\Pay\WithRedirect\Libraries\Requests\Exception;
use StephaneAss\Payplus\Pay\WithRedirect\Libraries\Requests\Transport;
...
class CURL implements Transport {
	...
	public function request($url, $headers = array(), $data = array(), $options = array()) {
		...
		if (curl_errno($this->fp)) {
			throw new Exception('cURL error ' . curl_errno($this->fp) . ': ' . curl_error($this->fp), 'curlerror', $this->fp);
			return;
		}
