<?php
namespace StephaneAss\Payplus\Pay\WithRedirect\Libraries\Requests;

use StephaneAss\Payplus\Pay\WithRedirect\Libraries\Requests\Exception\HTTP;
use StephaneAss\Payplus\Pay\WithRedirect\Libraries\Requests\Response\Headers;
...
class Response {
	 ...
	 * @throws HTTP On non-successful status code. Exception class corresponds to code (e.g. {@see Requests_Exception_HTTP_404})
