<?php
namespace StephaneAss\Payplus\Pay\WithRedirect\Libraries;

use StephaneAss\Payplus\Pay\WithRedirect\Libraries\Requests\Auth\Basic;
use StephaneAss\Payplus\Pay\WithRedirect\Libraries\Requests\Exception;
use StephaneAss\Payplus\Pay\WithRedirect\Libraries\Requests\Hooks;
use StephaneAss\Payplus\Pay\WithRedirect\Libraries\Requests\IDNAEncoder;
use StephaneAss\Payplus\Pay\WithRedirect\Libraries\Requests\IRI;
use StephaneAss\Payplus\Pay\WithRedirect\Libraries\Requests\Response;
use StephaneAss\Payplus\Pay\WithRedirect\Libraries\Requests\Transport\Fsockopen;
use StephaneAss\Payplus\Pay\WithRedirect\Libraries\Requests\Transport\CURL;
...
class Requests {
	 ...
	 *    (Auth|array|boolean, default: false)
	...
	public static function request($url, $headers = array(), $data = array(), $type = self::GET, $options = array()) {
		if (!preg_match('/^http(s)?:\/\//i', $url)) {
			throw new Exception('Only HTTP requests are handled.', 'nonhttp', $url);
		}
		$defaults = array(
			'timeout' => 10,
